		...
		switch ($mode)
		{
			...
			case 'view':
				...
				$template->assign_vars(array(
					...
					'CUR_FOLDER_NAME'		=> !$folder_status ?? $folder_status['folder_name'],
					...
					'FOLDER_STATUS'				=> !$folder_status ?? $folder_status['message'],
					'FOLDER_MAX_MESSAGES'		=> !$folder_status ?? $folder_status['max'],
					'FOLDER_CUR_MESSAGES'		=> !$folder_status ?? $folder_status['cur'],
					'FOLDER_REMAINING_MESSAGES'	=> !$folder_status ?? $folder_status['remaining'],
					'FOLDER_PERCENT'			=> !$folder_status ?? $folder_status['percent'])
				);
